...
$GLOBALS['TL_LANG']['tl_content']['sliderWrapperClass'] = ['Wrapper CSS class','Optional definition of the wrapper (useful if the slider is wrapped around a module for example).'];
