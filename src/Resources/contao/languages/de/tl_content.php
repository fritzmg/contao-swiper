...
$GLOBALS['TL_LANG']['tl_content']['sliderWrapperClass'] = ['Wrapper CSS Klasse','Die optionale CSS Klasse des Wrappers. Kann verwendet werden, wenn man z.B. durch eine Nachrichtenliste sliden möchte. Dann muss die Klassen des Listen-Containers angegeben werden (mod_newslist).'];
